...
// Modal to edit missed task
export default function EditMissedTaskModal(props) {
  ...
  function handleUpdateTask() {
    store.dispatch(updateTask({ category: props.category, from: "missed", oldTitle: oldTitle, task: { title: props.title, description: props.description, timestamp: props.timestamp } }));
    document.getElementById('edit-missed-task-details').checked = false;
    props.setTitle("");
  ...
  return (
    <ModalPortal>
      <input type="checkbox" id="edit-missed-task-details" className="modal-toggle" />
      <label htmlFor="edit-missed-task-details" className="modal cursor-pointer">
